...
/***/ "./src/frontend/common/variants.js":
/*!*****************************************!*\
  !*** ./src/frontend/common/variants.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   findActiveAttrOptions: () => (/* binding */ findActiveAttrOptions),
/* harmony export */   findMatchingVariations: () => (/* binding */ findMatchingVariations),
...
const cleanObj = (obj, removeEmpty = false) => {
...
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./context */ "./src/frontend/components/context.js");
/* harmony import */ var _common_variants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/variants */ "./src/frontend/common/variants.js");
/* harmony import */ var _AttrItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./AttrItem */ "./src/frontend/components/AttrItem.js");
...
const App = ({
  ...
  const [appId, setAppId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)("");
  const [attrs, setAttrs] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)({});
  ...
  const [availableAttrs, setAvailableAttrs] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [ajaxLoaded, setAjaxLoaded] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [variants, setVariants] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(initVariants?.length ? initVariants : []);
  ...
  const handleCheckVariants = (attrs, selected, variants) => {
    const findArgs = (0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.cleanObj)({
      ...selected,
      __t: null,
      __c: null
    });
    ...
    Object.values(attrs).map(attr => {
      ...
      const found = (0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.findMatchingVariations)(variants, args);
      const activeOpts = (0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.findActiveAttrOptions)(found, attr.name);
    ...
    if (attrLength > 0 && findArgsLength > 0 && attrLength === Object.keys(findArgs).length) {
      const matchingVariations = (0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.findMatchingVariations)(variants, findArgs);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_context__WEBPACK_IMPORTED_MODULE_3__.AppContext.Provider, {
    value: contentValues
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: classes.join(" ")
  }, Object.values(attrs).map(attr => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AttrItem__WEBPACK_IMPORTED_MODULE_5__["default"], {
    key: attr.id,
    attr: attr
  }))));
};
...
/***/ "./src/frontend/components/AttrItem.js":
/*!*********************************************!*\
  !*** ./src/frontend/components/AttrItem.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./context */ "./src/frontend/components/context.js");
/* harmony import */ var _Drawer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Drawer */ "./src/frontend/components/Drawer.js");
/* harmony import */ var _Option__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Option */ "./src/frontend/components/Option.js");
/* harmony import */ var _AttrOptions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./AttrOptions */ "./src/frontend/components/AttrOptions.js");
...
const AttrItem = ({
  ...
  const {
    ...
    selected,
    settings
  } = (0,_context__WEBPACK_IMPORTED_MODULE_3__.useAppContext)();
  const {
    selection = true
  } = settings;
  const [isOpen, setIsOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [isOpenModal, setOpenModal] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const refValue = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  let selectedLabel = "";
  ...
  const willShowDetail = settings?.viewAttrDetail && attr?.data?.description?.length;
  let optSettings = {};
  ...
  switch (attr.type) {
    ...
    default:
      ...
      optSelectedSettings = {
        ...(settings?.drawer?.option?.default || {})
      };
  }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: ["sasw_attr", attr.name, "atype-" + (attr?.type || "mixed"), "sasw_align_" + (settings?.align || "none")].join(" ")
  }, showAttrLabel && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_attr_label"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_label_title"
  }, attr?.label, showColon ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "colon"
  }, ":") : ""), showValue && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_label_val"
  }, selectedLabel)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ref: refValue,
    className: [!loop ? "sasw_attr_values" : "sasw_loop_values"].join(" ")
  }, inDrawer ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Option__WEBPACK_IMPORTED_MODULE_5__["default"], {
    option: option,
    attrName: attr.name,
    clickable: false,
    checkActive: false,
  ...
  })), settings?.layout === "popover" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isOpen && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
    placement: `bottom`,
    ...
    className: "sasw_popover_inner"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AttrOptions__WEBPACK_IMPORTED_MODULE_6__["default"], {
    attr: attr,
    settings: {
  ...
  })))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Drawer__WEBPACK_IMPORTED_MODULE_4__["default"], {
    isOpen: isOpen,
    onClose: e => {
      e.preventDefault();
      setIsOpen(false);
    },
    title: attr?.data?.button_label?.length ? attr?.data?.button_label : SASW_SWATCHES.i18n.select_attr.replace("%s", attr?.label)
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AttrOptions__WEBPACK_IMPORTED_MODULE_6__["default"], {
    attr: attr,
    settings: {
      // ...(settings?.drawer?.option || {}),
  ...
  }), willShowDetail ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    ...
    href: "#"
  }, attr?.data?.button_label?.length ? attr?.data?.button_label : SASW_SWATCHES.i18n.btn_details), isOpenModal && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Modal, {
    size: "large",
    className: "sasw_attr_desc_modal",
    title: attr?.data?.title,
    onRequestClose: () => setOpenModal(false)
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_modal_inner"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AttrItem);

/***/ }),

/***/ "./src/frontend/components/AttrOptions.js":
/*!************************************************!*\
  !*** ./src/frontend/components/AttrOptions.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Option__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Option */ "./src/frontend/components/Option.js");
...
const AttrOptions = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Option__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AttrOptions);

/***/ }),

/***/ "./src/frontend/components/Drawer.js":
/*!*******************************************!*\
  !*** ./src/frontend/components/Drawer.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _IconClose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IconClose */ "./src/frontend/components/IconClose.js");
...
const Drawer = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `drawer-overlay ${!open && 'h'} ${open && 'o'}`,
    onClick: onClose,
    "aria-hidden": "true"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    tabIndex: "-1",
    ...
    className: `drawer ${open && 'animate'} ${!open && 'h'} ${placement || 'right'} ${props.className || ''}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const AppDrawer = ({
  ...
  const [width, setWidth] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(window.innerWidth);
  const [height, setHeight] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(window.innerHeight);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const handleResize = () => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Drawer, {
    open: isOpen,
    onClose: onClose,
    ...
    height: width > 600 ? '100%' : height * 0.6,
    forceRender: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_head"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_head_inner"
  }, title && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_title"
  }, title), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_actions"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_drawer_btn sasw_close sasw_cursor",
    onClick: onClose
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_IconClose__WEBPACK_IMPORTED_MODULE_2__["default"], null))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_body"
  }, children), footer && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_footer"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_drawer_footer_inner"
  }, footer))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AppDrawer);

/***/ }),

/***/ "./src/frontend/components/IconCheck.js":
/*!**********************************************!*\
  !*** ./src/frontend/components/IconCheck.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/frontend/components/IconClose.js":
/*!**********************************************!*\
  !*** ./src/frontend/components/IconClose.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/frontend/components/Option.js":
/*!*******************************************!*\
  !*** ./src/frontend/components/Option.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./context */ "./src/frontend/components/context.js");
/* harmony import */ var _IconCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IconCheck */ "./src/frontend/components/IconCheck.js");
...
const Option = ({
  ...
  } = (0,_context__WEBPACK_IMPORTED_MODULE_1__.useAppContext)();
  const {
    selection = true,
    loop = false
  } = globalSettings;
  ...
  const optionSettings = {
    ...(0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.cleanObj)(option?.swatch || {}),
    ...(0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.cleanObj)(option?.custom_swatch || {})
  };
  let gloalSettings = {};
  ...
  const swatch = {
    ...(0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.cleanObj)(settings),
    ...(0,_common_variants__WEBPACK_IMPORTED_MODULE_4__.cleanObj)(optionSettings || {})
  };
  ...
  if (availableAttrs?.[attrName]) {
    if (availableAttrs?.[attrName]?.includes(option?.slug) || availableAttrs?.[attrName]?.includes("")) {
      isActive = true;
    } else {
      isActive = false;
      isClickable = false;
  ...
  const hasSwatch = ["sasw_image", "image", "sasw_color", "color"].includes(swatch?.type);
  if (selectedVal && ["sasw_image", "image"].includes(swatch?.type)) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_opt_wrap",
    style: css
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...divProps
  }, checkActive && ["checkbox"].includes(settings?.layout) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_checkbox_wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_checkbox"
  })), swatch?.type === "sasw_color" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch_wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch sasw_color",
    style: cssSwatch
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }), swatch?.more?.length ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, swatch?.more.map(c => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    key: c,
    className: "sasw_color_item",
    style: {
      background: `${c}`
    }
  }))) : null))) : null, swatch?.type === "sasw_image" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch_wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch sasw_image",
    style: cssSwatch
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_image_item"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    alt: "",
    src: swatch?.thumbnail || swatch?.full
  })))) : null, noSelect && !selectedVal && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch_wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_swatch sasw_no sasw_swatch_placeholder",
    style: cssSwatch
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_no_item"
  }, "..."))), willShowLabel && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "sasw_opt_label",
    style: cssSwatchLabel
  }, option?.custom_name || option?.name), !isCircle && showIcon && isChecked && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "sasw_icon"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_IconCheck__WEBPACK_IMPORTED_MODULE_2__["default"], null)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_tooltip__WEBPACK_IMPORTED_MODULE_3__.Tooltip, {
    className: "sasw_tooltip",
    style: {
      zIndex: 999999
    },
    id: tooltipId
...
/***/ "./src/frontend/components/context.js":
/*!********************************************!*\
  !*** ./src/frontend/components/context.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const AppContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)();
const useAppContext = () => {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useContext)(AppContext);
};
...
"use strict";
/*!**********************************!*\
  !*** ./src/frontend/swatches.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _swatches_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swatches.scss */ "./src/frontend/swatches.scss");
...
/* harmony import */ var _components_App__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/App */ "./src/frontend/components/App.js");
/* harmony import */ var _common_req__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/req */ "./src/common/req.js");
/* harmony import */ var _common_variants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./common/variants */ "./src/frontend/common/variants.js");
...
jQuery($ => {
  const preSettings = (0,_common_variants__WEBPACK_IMPORTED_MODULE_6__.cleanObj)(SASW_SWATCHES.settings, true);
  const {
    option = {}
  } = preSettings?.single || {};
  const {
  ...
  $(".variations_form").each(function () {
    ...
    const settings = {
      layout: preSettings?.single?.layout || "separate",
      // inline | separate | drawer
      viewAttrDetail: preSettings?.single?.viewAttrDetail !== "hide" ? true : false,
      option: option,
      drawer: {
        option: drawerOption
      }
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.render)((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_App__WEBPACK_IMPORTED_MODULE_4__["default"], {
      ...args
    }), appEl.get(0));
  });
  ...
  jQuery(".sasw_loop_swatches").each(function () {
    ...
    appEl.on("found_variation", function (evt, variation, findArgs) {
      ...
      if (isBlockBtn) {
        ...
        blockParent.attr("wc-context", JSON.stringify({
          ...blockContext,
          productId: variation.variation_id
        }));
        btnSpan.get(0).dispatchEvent(new CustomEvent("sasw_variation_change", {
          bubbles: true,
          detail: {
