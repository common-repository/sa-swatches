...
use function SASW_SWATCHES\Frontend\Product\get_option_settings;
...
function save_attribute_custom_meta($product)
{
	...
	try { 
		parse_str($_POST['data'], $data); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		if (!is_array($data)) {
			$data = [];
